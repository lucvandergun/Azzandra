...
namespace Azzandra
{
    public class VictoryInterface : Interface
    {
        ...
        private readonly string Title = "Victory!";

        public VictoryInterface(GameClient gameClient) : base(gameClient)
        {
            Buttons = new Button[]
            {
                new Button(ButtonSize, "Continue regardless")
                {
                    OnClick = () => {
                        Close();
                    }
