...
namespace Azzandra.Generation
{
    public class SpawnData
    {
        public static Dictionary<Type, SpawnData> DataDictionary = new Dictionary<Type, SpawnData>()
        {
            ...
            { typeof(Specter),      new SpawnData(9, 1, 1, 13, 21, Temp.Lukewarm, Temp.Warm) },
            { typeof(VineBlight),   new SpawnData(8, 1, 2, 11, 17, Temp.Lukewarm, Temp.Warm) },
            { typeof(ToxicSpider),  new SpawnData(2, 3, 3, 12, 19, Temp.Lukewarm, Temp.Warm) },
            ...
            { typeof(Troll),        new SpawnData(11, 1, 2, 9, 15, Temp.Freezing, Temp.Hot) },
            ...
            { typeof(DustMephit),   new SpawnData(8, 1, 2, 18, 27, Temp.Warm, Temp.Scorching) },
        };
